...
async def assign_ai(human_id: str, request: Request) -> AssignAiResponse:
...
async def reject(
    human_id: str, payload: RejectRequest, request: Request
) -> AssignAiResponse:
...
async def autopilot(human_id: str, request: Request) -> AssignAiResponse:
