...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-env-vars "AI_PROVIDER=gemini,JOB_RUNNER=cloud_tasks,GCP_PROJECT=${PROJECT_ID},GCP_LOCATION=${REGION},CLOUD_TASKS_QUEUE=${QUEUE_NAME},AI_GUARD_ENABLED=true,AI_DAILY_BUDGET_USD=${AI_DAILY_BUDGET_USD:-5.0},AI_RATE_MAX=${AI_RATE_MAX:-30},AI_RATE_WINDOW_SEC=${AI_RATE_WINDOW_SEC:-600}" \
