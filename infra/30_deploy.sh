...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --set-env-vars "AI_PROVIDER=gemini,JOB_RUNNER=cloud_tasks,GCP_PROJECT=${PROJECT_ID},GCP_LOCATION=${REGION},CLOUD_TASKS_QUEUE=${QUEUE_NAME},AI_GUARD_ENABLED=true,AI_DAILY_BUDGET_USD=${AI_DAILY_BUDGET_USD:-0.6},AI_RATE_MAX=${AI_RATE_MAX:-30},AI_RATE_WINDOW_SEC=${AI_RATE_WINDOW_SEC:-600},WRITE_RATE_MAX=${WRITE_RATE_MAX:-60},WRITE_RATE_WINDOW_SEC=${WRITE_RATE_WINDOW_SEC:-60}" \
